...
<div class="homedes border mt-10 ml-10 mr-10 flex justify-evenly items-center">
     <img class="imghome" src="./images/pc4.jpg" alt="">
     <div class="text-center">
      <h1 class="  text-center">ELECTRO<span class=" text-red-700">MAROC</span></h1>
     <br>
     <h2>A website for selling electronic devices of high quality. We welcome all visitors</h2>
     </div>
</div>
<div class="homedes border mt-10 ml-10 mr-10  flex snap-center top-12 relative justify-evenly items-center">
  <div class="text-center">
   <h1 class="  text-center">ELECTRO<span class=" text-red-700">MAROC</span></h1>
  <br>
  <h2>A website for selling electronic devices of high quality. We welcome all visitors</h2>
  </div>
  <img class="imghome" src="./images/accessoir5.webp" alt="">
</div>
<div class="homedes border mt-10 ml-10 mr-10  flex snap-center top-12 relative justify-evenly items-center">
  <img class="imghome" src="./images/phone2.png" alt="">
  <div class="text-center">
   <h1 class="  text-center">ELECTRO<span class=" text-red-700">MAROC</span></h1>
  <br>
  <h2>A website for selling electronic devices of high quality. We welcome all visitors</h2>
...
<div class="homedes border mt-10 ml-10 mr-10  flex snap-center top-12 relative justify-evenly items-center">
  ...
  <img class="imghome" style="width: 350px; height: 300px;" src="./images/img4.png" alt="">
</div>
  <!-- footer -->
  <footer class="relative top-16 text-center bg-gray-900 h-24 text-white">
